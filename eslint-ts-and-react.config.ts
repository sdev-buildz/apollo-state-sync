...
/**
 * The pattern to match all of the typescript and javascript file extensions used in the project.
 * Used in the files field of the ESLint configuration objects.
 * @see Reference {@link https://eslint.org/docs/latest/use/configure/configuration-files#specifying-files-and-ignores | link}
 */
export const extentionsPattern = '{js,mjs,cjs,ts,mts,cts,tsx}'
 ...
 * The ESLint configurations for the .ts and .tsx files.
 */
export const eslintReactConfig: Parameters<typeof defineConfig>[number] = [
  /**
